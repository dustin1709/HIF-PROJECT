...
function HomeBanner() {
    ...
    return (
        ...
        <div id="about" className='pt-5 pb-5'>
            <h1 className="pl-10" style={{fontSize: '350%', marginTop: '2%'}}>
                About HIF
            </h1>
            <div>
            ...
            <ul className='pl-10 pb-5 pt-2 pr-8 text-center'>
                    <li className="listItem">
                        ...
                        <h1 className='text-3xl' ref={ref}>{useScrollTriggeredCountUp(ref, 62)}+ Apartment Buildings</h1>
                    </li>
                    
                    <li className="listItem">
                    <div className="flex justify-center"><img src={room} alt='icon' style={{width: '3.5rem', paddingBottom: '0.5em'}} /></div>
                        <h1 className='text-3xl' ref={ref}>{useScrollTriggeredCountUp(ref, 892)}+ Apartments</h1>
                    </li>
                    
                    <li className="listItem">
                    <div className="flex justify-center"><img src={family} alt='icon' style={{width: '3.5rem', paddingBottom: '0.5em'}} /></div>
                        <h1 className='text-3xl' ref={ref}>{useScrollTriggeredCountUp(ref, 787)}+ Families</h1>
                    </li>
                    
                    <li className="listItem">
                    <div className="flex justify-center"><img src={country} alt='icon' style={{width: '3.5rem', paddingBottom: '0.5em'}} /></div>
                    <h1 className='text-3xl' ref={ref}>{useScrollTriggeredCountUp(ref, 7)}+ countries</h1>
                    </li>
                </ul>
